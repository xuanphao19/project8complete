...
interface ReactMagnifierDefaultState {}
...
export default class ReactMagnifier extends React.Component<ReactMagnifierProps, ReactMagnifierDefaultState> {
  ...
  private magnify(): void {
     ...
     */
    this.magnifiableImage.current.parentElement.insertBefore(this.glass, this.magnifiableImage.current);
    ...
    this.glass.style.boxShadow = this.props.magnifierShadow ? "0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);" : "none";
    ...
    this.glass.style.backgroundSize =
      this.magnifiableImage.current.width * this.props.zoomSize + "px " + this.magnifiableImage.current.height * this.props.zoomSize + "px";
  ...
  private moveMagnifier = (e: any) => {
    ...
    this.glass.style.backgroundPosition =
      "-" + (x * this.props.zoomSize - this.width + this.pixelPadding) + "px -" + (y * this.props.zoomSize - this.height + this.pixelPadding) + "px";
