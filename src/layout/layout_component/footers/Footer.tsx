  ...
  <footer
    ...
    <MainSection
      ...
      <div className="footer-copyright text-center pt-5 pb-3">
        <a
          className="pt-3 spacing-15 flex-center text-nowrap"
          target="_blank"
          rel="noopener noreferrer"
          href="https://fullstack.edu.vn/">
          <span className="copyright flex-center fs-5 fw-light fst-italic">
            <span className="fs-1">&copy;</span>
            <span className="px-3">{`${new Date().toLocaleDateString("vi-VN")}`}</span>Copyright:
          </span>
