    ...
    <MainSection
      ...
      <div className="text-md-left">
        <div className="row text-body text-opacity-75 row-gap-5">
          <div className="col-lg-6 mt-md-0 py-3 mt-3">
            <div className="row">
              ...
              <div className="footer-about d-none d-md-block col-md-4">
                <h5 className="text-uppercase p-2 ps-4 fw-medium">About</h5>
                <MenuLists
          ...
          <div className="col-lg-6 mt-md-0 py-3 px-0 mt-3">
            <div className="row w-100">
              ...
              <div className="footer-company d-none d-sm-block col-sm-4 mx-auto">
                <h5 className="text-uppercase p-2 ps-4 fw-medium">Company</h5>
                <MenuLists
              ...
              <div className="footer-started col-sm-4 d-block mx-auto">
                <h5 className="text-uppercase p-2 ps-4 ps-sm-5 fw-medium">Getting Started</h5>
                <MenuLists
                  items={mapNavFooter.started}
                  type="nav"
                  className="py-3 ps-4 ps-sm-5 fw-light"
                  linkClass="w-100 p-2"
                />
              </div>
            </div>
