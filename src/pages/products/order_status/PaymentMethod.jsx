        ...
        <article className="pay-item mb-5">
          <div className="pay-info px-5 py-4 rounded-5 bg-body">
            ...
            <div className="pay-desc d-flex align-items-center justify-content-between py-1 mb-0">
              ...
              <ModalVideojs
                overlayOpacity={90}
                videoUrl="/assets/video/OfficialMusic.mp4">
                <button
                  type="button"
                  className="btn-view-detail flex-center gap-2 user-select-none hover-100 opacity-75">
                  <IconSvg
                    type="button"
                    className={`icon-ctrl text-info fs-1`}
                    link="play-circle"
                  />
                  <span className="fst-italic fs-4 text-info-emphasis fw-light">Watch Video</span>
                </button>
              </ModalVideojs>
            </div>
          </div>
          ...
          <div className="pay-info d-flex align-items-center py-2 px-3 rounded-5 bg-body">
            <div className="col-2 m-0">
              <Image
                ...
                src={`/assets/images/product/product310.png`}
              />
            </div>
        ...
        <article
          ...
          <div className="pay-info d-flex align-items-center py-2 px-3 rounded-5 bg-body">
            <div className="col-2 m-0">
              <Image
                className="w-100 p-4 h-auto rounded-5 d-flex"
                src={`/assets/images/product/product311.png`}
              />
            </div>
            <div className="pay-info ms-4">
