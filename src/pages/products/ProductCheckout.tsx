...
import { useRef, useEffect, createRef, memo } from "react";
...
const ProductCheckout = memo(() => {
  ...
  return (
    <Fragment>
            ...
            <div className={`${!matchPay ? "px-5 py-3 bg-secondary-subtle rounded-5 shadow" : ""}`}>
              ...
              {!matchPay && (
                <div className="">
                          ...
                          <Row className="content">
                            ...
                            <Col className="col-8 col-md-5">
                              <div className="py-3 d-flex h-100 flex-column">
                                ...
                                <Row className="ctrl flex-center row-cols-2 mt-3">
                                  ...
                                  <Col className="form-group">
                                    <CountProducts
                                      ...
                                      className="ctrl-item form-control d-flex align-items-center justify-content-between mb-4 mt-md-0 fs-3 user-select-none border rounded-3"
                  ...
                  <div
                    id="anchor-checkout"
                    className="anchor-point scroll-margin-top180"></div>
      ...
      {!matchPay && <div className="see-more mb-5 ps-5 p-3 fs-1 bg-secondary bg-opacity-75 shadow">Xem thêm mặt hàng cùng khoảng giá:</div>}
    </Fragment>
  );
});
